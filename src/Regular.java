...
public class Regular extends Savings implements Compound_Interest{
    public Regular(String customerNumber, String customerName, String initialDeposit, String numOfYears, String typeOfSavings) throws SQLException, ClassNotFoundException {
